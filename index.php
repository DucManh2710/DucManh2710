    ...
    <div id="main">
        ...
        <div id="slider">
            <div class="box-left">
                ...
                <p>Join us on the mission of sharing
                    happiness, one pizza at a time.</p>
            ...
            <div id="sub-content">
                <div class="row">
                    <div class="banner">
                        ...
                        <div class="banner-body">
                            <p>Pizza 4P’s Lotte West Lake</p>
                    ...
                    <div class="banner">
                        ...
                        <div class="banner-body">
                            <p>Pizza 4P’s Aeon Mall Ha Dong</p>
                ...
                <div class="row">
                    ...
                    <div class="banner">
                        ...
                        <div class="banner-body">
                            <p>Pizza 4P’s Aeon Mall Hải Phòng</p>
    ...
    <div class="modal js-modal">
        <div class="modal-container js-modal-container">
                ...
                <div class="modal-body">
                    ...
                    <input id="username" name="username" type="text" class="modal-input" placeholder="Tên đăng nhập">

                    <label for="password" class="modal-label">
                        
                        Mật khẩu
                    </label>
                    <input id="password" name="password" type="password" class="modal-input" placeholder="Mật khẩu">
